...
#define _OP(_node_)   OperatorsTable[_node_->value.operator_code]

//------------------------------------------------------------------------------

#define VAR_SIZE sizeof(double)
...
#define ASM(...)                                                      \
                                                                      \
    fprintf(ctx->output_file, "%*s", 8*ctx->level, "");               \
