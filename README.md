...
Было проведено RUNS=1000 запусков тестовой программы с предварительно зафиксированной частотой процессора — 3.8 ГГц. С помощью инструкции rdtsc было посчитано количество тактов затраченное на исполнение программы в каждом запуске. Далее были посчитаны среднее время исполнения и среднеквадратичное отклонение.

### Результаты измерений
|Машина      |Время исполнения, мс|
|------------|--------------------|
|Виртуальная |30.0 ± 5.7          |
|x86-64      |0.20 ± 0.05         |
